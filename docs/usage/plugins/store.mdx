---
title: deepnova Plugin Store
description: >-
  Learn how to access the Plugin Store in deepnova to easily install and use various plugins for enhanced functionality.
...
In the plugin store, you can directly install and use plugins in deepnova.
