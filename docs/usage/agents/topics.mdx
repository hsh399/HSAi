---
title: deepnova Topic Usage Guide
description: >-
  Learn how to save and manage topics during conversations in deepnova, including saving topics, accessing the topic list, and pinning favorite topics.
