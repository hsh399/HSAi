---
title: Custom deepnova Assistant Guide - Adding and Iterating Assistants
description: >-
  Learn how to add assistants to your favorites list in deepnova through the role market or by creating custom assistants. Explore detailed steps for creating custom assistants and quick setup tips.
...
As the basic functional unit of deepnova, adding and iterating assistants is very important. Now you can add assistants to your favorites list in two ways.

## `A` Add through the role market

If you are a beginner in Prompt writing, you might want to browse the assistant market of deepnova first. Here, you can find commonly used assistants submitted by others and easily add them to your list with just one click, which is very convenient.
