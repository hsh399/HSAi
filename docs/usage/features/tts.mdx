---
title: deepnova support Speech Synthesis and Recognition (TTS & STT)
description: >-
  Experience seamless Text-to-Speech (TTS) and Speech-to-Text (STT) technologies in deepnova. Choose from a variety of high-quality voices for personalized communication. Learn more about Lobe TTS toolkit @lobehub/tts.
...
<Callout type={'info'}>
  During the implementation of the TTS feature in deepnova, we found that there was no good frontend
