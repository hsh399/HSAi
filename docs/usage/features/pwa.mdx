---
title: deepnova support Progressive Web Apps (PWA)
description: >-
  Discover how deepnova utilizes Progressive Web App (PWA) technology to provide a seamless and near-native app experience on both desktop and mobile devices. Learn how to install deepnova as a desktop app for enhanced convenience.
...
<Callout type={'tip'}>
  The default installed deepnova PWA icon has a black background, you can use <kbd>cmd</kbd> +{' '}
