---
title: 在 deepnova 中使用 Azure AI API Key
description: 学习如何在 deepnova 中配置和使用 Azure AI 模型，获取 API 密钥并开始对话。
tags:
  - deepnova
  - Azure AI
  - API密钥
...
# 在 deepnova 中使用 Azure AI

<Image alt={'在 deepnova 中使用 Azure AI '} cover src={'https://github.com/user-attachments/assets/81d0349a-44fe-4dfc-bbc4-8e9a1e09567d'} />
...
本文档将指导你如何在 deepnova 中接入 Azure AI 的模型:
...
至此你已经可以在 deepnova 中使用 Azure AI 提供的模型进行对话了。
