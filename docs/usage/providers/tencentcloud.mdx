---
title: Using Tencent Cloud API Key in deepnova
description: Learn how to configure and use Tencent Cloud AI models in deepnova, obtain an API key, and start a conversation.
tags:
  - deepnova
  - Tencent Cloud
  - API Key
...
# Using Tencent Cloud in deepnova

<Image alt={'Using Tencent Cloud in deepnova'} cover src={'https://github.com/user-attachments/assets/aa91ca54-65fc-4e33-8c76-999f0a5d2bee'} />
...
This document will guide you on how to connect Tencent Cloud's AI models in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in deepnova

  - Visit the `Application Settings` and `AI Service Provider` interface of deepnova.
...
You can now use the models provided by Tencent Cloud in deepnova to have conversations.
