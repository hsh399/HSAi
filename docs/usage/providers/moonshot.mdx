---
title: Using Moonshot AI API Key in deepnova
description: >-
  Learn how to integrate Moonshot AI into deepnova for AI-powered conversations. Follow the steps to get the API key, configure Moonshot AI, and start engaging with AI models.
...
# Using Moonshot AI in deepnova

<Image alt={'Using Moonshot AI in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/21b94782-875b-4dee-a572-3c5843f3e1e3'} />

The Moonshot AI API is now available for everyone to use. This document will guide you on how to use [Moonshot AI](https://www.moonshot.cn/) in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Moonshot AI in deepnova
...
You can now engage in conversations using the models provided by Moonshot AI in deepnova.
