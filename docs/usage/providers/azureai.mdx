---
title: Using Azure AI API Key in deepnova
description: Learn how to configure and use Azure AI models in deepnova, get the API key, and start a conversation.
tags:
  - deepnova
  - Azure AI
  - API Key
...
# Using Azure AI in deepnova

<Image alt={'Using Azure AI in deepnova'} cover src={'https://github.com/user-attachments/assets/81d0349a-44fe-4dfc-bbc4-8e9a1e09567d'} />
...
This document will guide you on how to integrate Azure AI models into deepnova:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in deepnova

  - Visit the `App Settings` and `AI Service Provider` interface in deepnova.
...
Now you can use the models provided by Azure AI in deepnova for conversations.
