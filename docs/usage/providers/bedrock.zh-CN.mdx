---
title: 在 deepnova 中使用 Amazon Bedrock API Key
description: 学习如何在 deepnova 中配置和使用 Amazon Bedrock，一个完全托管的基础模型API服务，以便开始对话。
tags:
  - Amazon Bedrock
  - Claude 3.5 sonnect
  - API keys
...
# 在 deepnova 中使用 Amazon Bedrock

<Image alt={'在 deepnova 中使用 Amazon Bedrock'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/74768b36-28ca-4ec3-a42d-b32abe2c7057'} />
...
本文档将指导你如何在 deepnova 中使用 Amazon Bedrock:
...
<Steps>
  ...
  ### 步骤三：在 deepnova 中配置 Amazon Bedrock

  - 访问 deepnova 的`设置`界面
  - 在`AI 服务商`下找到`Amazon Bedrock`的设置项并打开

  <Image alt={'deepnova 中填写 Amazon Bedrock 密钥'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/7468594b-3355-4cb9-85bc-c9dace137653'} />
...
至此你已经可以在 deepnova 中使用 Amazone Bedrock 提供的模型进行对话了。
