---
title: 在 deepnova 中使用360智脑
description: 学习如何在 deepnova 中配置和使用360智脑的API Key，以便开始对话和交互。
tags:
  - deepnova
  - 360智脑
  - API密钥
...
至此你已经可以在 deepnova 中使用 360 智脑提供的模型进行对话了。
