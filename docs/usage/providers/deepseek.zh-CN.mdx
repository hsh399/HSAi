---
title: 在 deepnova 中使用 DeepSeek API Key
description: 学习如何在 deepnova 中配置和使用 DeepSeek 语言模型，获取 API 密钥并开始对话。
tags:
  - deepnova
  - DeepSeek
  - DeepSeek R1
...
# 在 deepnova 中使用 DeepSeek

<Image alt={'在 deepnova 中使用 DeepSeek'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52'} />
...
本文档将指导你如何在 deepnova 中使用 DeepSeek：
...
至此你已经可以在 deepnova 中使用 Deepseek 提供的模型进行对话了。
