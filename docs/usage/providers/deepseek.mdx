---
title: Using DeepSeek API Key in deepnova
description: >-
  Learn how to use DeepSeek-V2 in deepnova, obtain API keys. Get started with DeepSeek integration now!
...
# Using DeepSeek in deepnova

<Image alt={'Using DeepSeek in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52'} />
...
This document will guide you on how to use DeepSeek in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure DeepSeek in deepnova

  - Access the `App Settings` interface in deepnova.
...
You can now engage in conversations using the models provided by Deepseek in deepnova.
