---
title: Using OpenRouter API Key in deepnova
description: >-
  Learn how to integrate and utilize OpenRouter's language model APIs in deepnova. Follow these steps to register, create an API key, recharge credit, and configure OpenRouter for seamless conversations.
...
# Using OpenRouter in deepnova

<Image alt={'Using OpenRouter in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/40520a43-ac03-4954-8a4d-282fbb946066'} />
...
This document will guide you on how to use OpenRouter in deepnova:
...
<Steps>
  ...
  - Name your API key in the pop-up dialog, for example, "deepnova Key"
  ...
  ### Step 4: Configure OpenRouter in deepnova
  ...
  <Image alt={'Configure OpenRouter in deepnova'} height={518} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/5c3898ab-23d7-44c2-bbd9-b255e25e400c'} />
...
You can now engage in conversations using the models provided by OpenRouter in deepnova.
