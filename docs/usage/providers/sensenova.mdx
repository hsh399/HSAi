---
title: Using SenseNova in deepnova
description: >-
...
This article will guide you on how to use SenseNova in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in deepnova

  - Access the `Settings` interface on deepnova.
...
You can now have conversations using the models provided by SenseNova in deepnova.
