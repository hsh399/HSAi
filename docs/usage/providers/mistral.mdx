---
title: Using Mistral AI API Key in deepnova
description: >-
  Learn how to integrate Mistral AI into deepnova for enhanced conversational experiences. Follow the steps to configure Mistral AI and start using its models.
...
# Using Mistral AI in deepnova

<Image alt={'Using Mistral AI in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/a3f9f63a-48f8-4567-b960-7f3636c0d4ed'} />

The Mistral AI API is now available for everyone to use. This document will guide you on how to use [Mistral AI](https://mistral.ai/) in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Mistral AI in deepnova
...
You can now engage in conversations using the models provided by Mistral AI in deepnova.
