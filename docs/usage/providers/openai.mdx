---
title: Using OpenAI API Key in deepnova
description: >-
  Learn how to integrate OpenAI API Key in deepnova. Support GPT-4o / GPT-4-turbo / GPT-4-vision
...
# Using OpenAI in deepnova

<Image alt={'Using OpenAI in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'} />

This document will guide you on how to use [OpenAI](https://openai.com/) in deepnova:
...
You can now engage in conversations using the models provided by OpenAI in deepnova.
