---
title: Using Google Gemini API Key in deepnova
description: >-
  Learn how to integrate and utilize Google Gemini AI in deepnova to enhance your conversational experience. Follow these steps to configure Google Gemini and start leveraging its powerful capabilities.
...
# Using Google Gemini in deepnova

<Image alt={'Using Google Gemini in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/9a8dc1d4-152b-415f-a7cd-8f0c8fbb9913'} />
...
This document will guide you on how to use Google Gemini in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure OpenAI in deepnova

  - Go to the `Settings` interface in deepnova
  - Find the setting for `Google Gemini` under `AI Service Provider`

  <Image alt={'Enter Google Gemini API Key in deepnova'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/11442ce4-a615-49c4-937a-ca2ae93dd27c'} />
...
Congratulations! You can now use Google Gemini in deepnova.
