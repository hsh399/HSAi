---
title: Using xAI in deepnova
description: >-
  Learn how to configure and use xAI's API Key in deepnova to start conversations and interactions.
...
This article will guide you on how to use xAI in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure xAI in deepnova

  - Go to the `Settings` menu in deepnova
...
You are now ready to engage in conversations using the models provided by xAI in deepnova.
