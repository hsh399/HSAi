---
title: Using iFLYTEK Spark in deepnova
description: Learn how to integrate and utilize iFLYTEK's Spark model APIs in deepnova.
tags:
  - deepnova
  - iFLYTEK
  - Spark
...
# Using iFLYTEK Spark in deepnova
...
This guide will instruct you on how to use iFLYTEK Spark in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in deepnova

  - Access the `Settings` menu in deepnova
...
Now you can use the models provided by iFLYTEK Spark for conversations in deepnova.
