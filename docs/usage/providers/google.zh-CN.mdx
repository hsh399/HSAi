---
title: 在 deepnova 中使用 Google Gemini API Key
description: 本文将指导你如何在 deepnova 中配置并使用 Google Gemini，一个由 Google AI 创建的强大语言模型。
tags:
  - Google Gemini
  - Google AI
  - API 密钥
...
# 在 deepnova 中使用 Google Gemini

<Image alt={'在 deepnova 中使用 Google Gemini'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/9a8dc1d4-152b-415f-a7cd-8f0c8fbb9913'} />

Gemini AI 是由 Google AI 创建的一组大型语言模型（LLM），以其在多模式理解和处理方面的尖端进步而闻名。它本质上是一个强大的人工智能工具，可以处理涉及不同类型数据的各种任务，而不仅仅是文本。

本文档将指导你如何在 deepnova 中使用 Google Gemini:
...
<Steps>
  ...
  ### 步骤二：在 deepnova 中配置 OpenAI

  - 访问 deepnova 的`设置`界面
  - 在`AI 服务商`下找到`Google Gemini`的设置项

  <Image alt={'deepnova 中填写 Google Gemini API 密钥'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/11442ce4-a615-49c4-937a-ca2ae93dd27c'} />
...
至此，你已经可以在 deepnova 中使用 Google Gemini 啦。
