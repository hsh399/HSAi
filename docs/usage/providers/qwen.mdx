---
title: Using Qwen2 API Key in deepnova
description: >-
  Learn how to integrate and utilize Tongyi Qianwen, a powerful language model by Alibaba Cloud, in deepnova for various tasks. Follow the steps to activate the service, obtain the API key, and configure Tongyi Qianwen for seamless interaction.
...
# Using Tongyi Qianwen in deepnova

<Image alt={'Using Tongyi Qianwen in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/4e057b43-1e3e-4e96-a948-7cdbff303dcb'} />
...
This document will guide you on how to use Tongyi Qianwen in deepnova:
...
<Steps>
  ...
  ### Step 3: Configure Tongyi Qianwen in deepnova
...
You can now engage in conversations using the models provided by Tongyi Qianwen in deepnova.
