---
title: Using Stepfun API Key in deepnova
description: >-
  Learn how to integrate Stepfun AI models into deepnova for engaging conversations. Obtain Stepfun API key, configure Stepfun in deepnova settings, and select a model to start chatting.
...
# Using Stepfun in deepnova

<Image alt={'Using Stepfun in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563'} />
...
This document will guide you on how to use Stepfun in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in deepnova
...
You can now use the models provided by Stepfun to have conversations in deepnova.
