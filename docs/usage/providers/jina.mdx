---
title: Using Jina AI API Key in deepnova
description: Learn how to configure and use Jina AI models in deepnova, obtain an API key, and start conversations.
tags:
  - deepnova
  - Jina AI
  - API Key
...
# Using Jina AI in deepnova

<Image alt={'Using Jina AI in deepnova'} cover src={'https://github.com/user-attachments/assets/840442b1-bf56-4a5f-9700-b3608b16a8a5'} />
...
This document will guide you on how to use Jina AI in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Jina AI in deepnova

  - Visit deepnova's `Application Settings` interface.
...
Now you can use the models provided by Jina AI in deepnova to have conversations.
