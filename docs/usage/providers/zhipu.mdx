---
title: Using Zhipu ChatGLM API Key in deepnova
description: >-
  Learn how to integrate and utilize Zhipu AI models in deepnova for enhanced conversational experiences. Obtain the API key, configure settings, and start engaging with cognitive intelligence.
...
# Using Zhipu ChatGLM in deepnova

<Image alt={'Using Together AI in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/497e3b20-57ca-4963-b6f4-897c9710c16e'} />
...
This document will guide you on how to use Zhipu AI in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Zhipu AI in deepnova

  - Visit the `Settings` interface in deepnova
  - Under `AI Service Provider`, locate the settings for Zhipu AI

  <Image alt={'Enter Zhipu AI API Key in deepnova'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/2afffe79-1d37-423c-9363-f09605d5e640'} />
...
You can now engage in conversations using the models provided by Zhipu AI in deepnova.
