---
title: 在 deepnova 中使用 Minimax API Key
description: >-
  学习如何在 deepnova 中配置并使用 MiniMax 智能模型进行对话。获取 MiniMax API 密钥、配置步骤详解，开始与 MiniMax 模型交互。
...
# 在 deepnova 中使用 Minimax

<Image alt={'在 deepnova 中使用 Minimax'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/703f170b-c03b-4c71-b57d-c2357596bdfb'} />
...
本文档将指导你如何在 deepnova 中使用 Minimax:
...
至此你已经可以在 deepnova 中使用 MiniMax 提供的模型进行对话了。
