---
title: Using Together AI in deepnova API Key
description: >-
  Learn how to integrate Together AI into deepnova, obtain the API key, configure settings, and start conversations with AI models.
...
# Using Together AI in deepnova

<Image alt={'Using Together AI in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/28e025dd-367b-4add-85b6-499f4aacda61'} />
...
This document will guide you on how to use Together AI in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Together AI in deepnova

  - Visit the `Settings` interface in deepnova
  - Find the setting for `together.ai` under `AI Service Provider`

  <Image alt={'Enter Together AI API key in deepnova'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/0cc6c9b8-4688-472b-a80f-f84c5ebbc719'} />
...
You can now engage in conversations using the models provided by Together AI in deepnova.
