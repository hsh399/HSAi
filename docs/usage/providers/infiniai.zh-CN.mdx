---
title: 在 deepnova 中使用无问芯穹
description: 学习如何在 deepnova 中配置和使用无问芯穹的 API Key，实现 AI 对话交互。
tags:
  - deepnova
  - 无问芯穹
  - API密钥
...
本文将指导你如何在 deepnova 中快速接入无问芯穹的 AI 能力。
...
<Steps>
  ...
  ### 步骤二：配置 deepnova 模型服务

  - 打开 deepnova 进入「设置」界面
