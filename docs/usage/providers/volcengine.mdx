---
title: Using the Volcano Engine API Key in deepnova
description: Learn how to configure and use the Volcano Engine AI model in deepnova, obtain API keys, and start conversations.
tags:
  - deepnova
  - Volcengine
  - Doubao
...
# Using Volcengine in deepnova

<Image alt={'Using Volcengine in deepnova'} cover src={'https://github.com/user-attachments/assets/b9da065e-f964-44f2-8260-59e182be2729'} />
...
This document will guide you on how to use Volcengine in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in deepnova

  - Navigate to the `Application Settings` page in deepnova and select `AI Service Providers`.
...
You can now use the models provided by Volcengine for conversations in deepnova.
