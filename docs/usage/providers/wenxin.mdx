---
title: Using Wenxin Qianfan in deepnova
description: >-
  Learn how to integrate and utilize Wenxin Qianfan's language model APIs in deepnova.
...
# Using Wenxin Qianfan in deepnova
...
This article will guide you on how to use Wenxin Qianfan in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in deepnova

  - Go to the `Settings` page of deepnova
...
You can now use the models provided by Wenxin Qianfan for conversations in deepnova.
