---
title: Using SambaNova API Key in deepnova
description: Learn how to configure and use SambaNova models in deepnova, obtain an API key, and start a conversation.
tags:
  - deepnova
  - SambaNova
  - API Key
...
# Using SambaNova in deepnova

<Image alt={'Using SambaNova in deepnova'} cover src={'https://github.com/user-attachments/assets/1028aa1a-6c19-4191-b28a-2020e5637155'} />
...
This document will guide you on how to use SambaNova in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in deepnova
...
Now you can use the models provided by SambaNova in deepnova to conduct conversations.
