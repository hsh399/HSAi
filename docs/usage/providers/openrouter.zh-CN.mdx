---
title: 在 deepnova 中使用 OpenRouter API Key
description: 学习如何在 deepnova 中注册、创建 API Key、充值信用额度并配置 OpenRouter，以便开始使用多种优秀大语言模型 API。
tags:
  - OpenRouter
  - API Key
  - Web UI
...
# 在 deepnova 中使用 OpenRouter

<Image alt={'在 deepnova 中使用 OpenRouter'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/40520a43-ac03-4954-8a4d-282fbb946066'} />
...
本文档将指导你如何在 deepnova 中使用 OpenRouter:
...
<Steps>
  ...
  - 点击 `Create Key` 开始创建
  - 在弹出对话框中为 API 密钥取一个名字，例如 "deepnova Key"
  ...
  ### 步骤四：在 deepnova 中配置 OpenRouter

  - 访问 deepnova 的 `设置` 界面
  - 在 `AI 服务商` 下找到 `OpenRouter` 的设置项
  - 打开 OpenRouter 并填入获得的 API 密钥

  <Image alt={'在 deepnova 中配置 OpenRouter'} height={518} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/5c3898ab-23d7-44c2-bbd9-b255e25e400c'} />
...
至此你已经可以在 deepnova 中使用 OpenRouter 提供的模型进行对话了。
