...
description: Learn how to configure and use ModelScope provider in deepnova
tags:
  - ModelScope
---
...
ModelScope (魔塔社区) is Alibaba's open-source model community that provides access to various AI models. This guide will help you set up the ModelScope provider in deepnova.
...
3. **Get API Token**
   ...
   - Copy the token for use in deepnova
...
For deepnova integration issues:
