---
title: Using Anthropic Claude API Key in deepnova
description: >-
  Learn how to integrate Anthropic Claude API in deepnova to enhance your AI assistant capabilities. Support Claude 3.5 sonnet / Claude 3 Opus / Claude 3 haiku
...
# Using Anthropic Claude in deepnova

<Image alt={'Using Anthropic Claude in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/620b956b-dcb2-442a-8bb1-9aa22681dfa4'} />

The Anthropic Claude API is now available for everyone to use. This document will guide you on how to use [Anthropic Claude](https://www.anthropic.com/api) in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Anthropic Claude in deepnova
...
You can now engage in conversations using the models provided by Anthropic Claude in deepnova.
