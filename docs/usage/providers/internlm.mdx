---
title: Using InternLM in deepnova
description: >-
  Learn how to configure and use SenseNova's API Key in deepnova to start conversations and interactions.
...
This article will guide you on how to use InternLM in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in deepnova
...
You are now ready to engage in conversations using the models provided by InternLM in deepnova.
