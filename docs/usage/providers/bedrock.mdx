---
title: Using Amazon Bedrock API Key in deepnova
description: >-
  Learn how to integrate Amazon Bedrock models into deepnova for AI-powered conversations. Follow these steps to grant access, obtain API keys, and configure Amazon Bedrock.
...
# Using Amazon Bedrock in deepnova

<Image alt={'Using Amazon Bedrock in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/74768b36-28ca-4ec3-a42d-b32abe2c7057'} />
...
This document will guide you on how to use Amazon Bedrock in deepnova:
...
<Steps>
  ...
  ### Step 3: Configure Amazon Bedrock in deepnova

  - Access the `Settings` interface in deepnova
  - Find the setting for `Amazon Bedrock` under `AI Service Provider` and open it

  <Image alt={'Enter Amazon Bedrock keys in deepnova'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/7468594b-3355-4cb9-85bc-c9dace137653'} />
...
You can now engage in conversations using the models provided by Amazon Bedrock in deepnova.
