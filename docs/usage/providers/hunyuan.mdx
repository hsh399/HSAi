---
title: Using Tencent Hunyuan in deepnova
description: >-
  Learn how to integrate and utilize Tencent Hunyuan's language model APIs in deepnova.
...
# Using Tencent Hunyuan in deepnova
...
This article will guide you on how to use Tencent Hunyuan in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure Tencent Hunyuan in deepnova

  - Go to the `Settings` page in deepnova
...
You can now engage in conversations using the models provided by Tencent Hunyuan in deepnova.
