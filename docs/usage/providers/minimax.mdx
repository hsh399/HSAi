---
title: Using Minimax API Key in deepnova
description: >-
  Learn how to use MiniMax in deepnova to enhance AI conversations. Obtain MiniMax API key, configure MiniMax in deepnova settings, and select a model for your AI assistant.
...
# Using Minimax in deepnova

<Image alt={'Using Minimax in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/703f170b-c03b-4c71-b57d-c2357596bdfb'} />
...
This document will guide you on how to use Minimax in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in deepnova

  - Go to the `Settings` interface of deepnova
...
You can now use the models provided by MiniMax to have conversations in deepnova.
