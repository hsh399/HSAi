---
title: Using GitHub Models in deepnova
description: Learn how to integrate and utilize GitHub Models in deepnova.
tags:
  - deepnova
  - GitHub
  - GitHub Models
...
# Using GitHub Models in deepnova
...
This article will guide you on how to use GitHub Models in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in deepnova

  - Navigate to the `Settings` interface in deepnova.
...
You are now ready to use the models provided by GitHub for conversations within deepnova.
