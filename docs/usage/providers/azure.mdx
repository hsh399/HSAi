---
title: Using Azure OpenAI API Key in deepnova
description: >-
  Learn how to integrate and configure Azure OpenAI in deepnova to enhance your AI assistant capabilities. Follow these steps to obtain the API key, configure the settings, and start engaging in conversations.
...
# Using Azure OpenAI in deepnova

<Image alt={'Azure OpenAI in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/5efa34c2-6523-43e6-9ade-70ab5d802e13'} />

This document will guide you on how to use [Azure OpenAI](https://oai.azure.com/) in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Azure OpenAI in deepnova
...
Now you can engage in conversations using the models provided by Azure OpenAI in deepnova.
