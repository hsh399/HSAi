---
title: Using LM Studio in deepnova
description: Learn how to configure and use LM Studio, and run AI models for conversations in deepnova through LM Studio.
tags:
  - deepnova
  - LM Studio
  - Open Source Model
...
# Using LM Studio in deepnova

<Image alt={'Using LM Studio in deepnova'} cover src={'https://github.com/user-attachments/assets/cc1f6146-8063-4a4d-947a-7fd6b9133c0c'} />
...
This document will guide you on how to use LM Studio in deepnova:
...
<Steps>
  ...
  ### Step 5: Use LM Studio in deepnova

  - Visit the `AI Service Provider` interface in deepnova's `Application Settings`.
...
Now you can use the model running in LM Studio in deepnova for conversations.
