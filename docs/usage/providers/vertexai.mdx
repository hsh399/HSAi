---
title: Using Vertex AI API Key in deepnova
description: Learn how to configure and use Vertex AI models in deepnova, get an API key, and start a conversation.
tags:
  - deepnova
  - Vertex AI
  - API Key
...
# Using Vertex AI in deepnova

<Image alt={'Using Vertex AI in deepnova'} cover src={'https://github.com/user-attachments/assets/638dcd7c-2bff-4adb-bade-da2aaef872bf'} />
...
This document will guide you on how to connect Vertex AI models in deepnova:
...
<Steps>
  ...
  ### Step 3: Configure Vertex AI in deepnova

  - Visit the `App Settings` and then the `AI Service Provider` interface in deepnova.
...
Now you can use the models provided by Vertex AI for conversations in deepnova.
