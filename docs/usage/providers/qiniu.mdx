---
title: Using Qiniu API Key in deepnova
description: >-
  Learn how to integrate and utilize powerful language models developed by Qiniu into deepnova for various tasks. Follow the steps to obtain an API key and configure it for seamless interaction.
...
# Using Qiniu's AI Models in deepnova

<Image alt={"Using Qiniu's AI Models in deepnova"} cover src={'https://github.com/user-attachments/assets/3ad2655e-dd20-4534-bf6d-080b3677df86'} />
...
This document will guide you on how to use Qiniu's AI Models in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Qiniu's AI Model Service in deepnova
...
You can now engage in conversations using the models provided by Qiniu in deepnova.
