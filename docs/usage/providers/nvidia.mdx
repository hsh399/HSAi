---
title: Using Nvidia NIM API Key in deepnova
description: Learn how to configure and use Nvidia NIM AI models in deepnova, obtain an API key, and start a conversation.
tags:
  - deepnova
  - Nvidia NIM
  - API Key
...
# Using Nvidia NIM in deepnova

<Image alt={'Using Nvidia NIM in deepnova'} cover src={'https://github.com/user-attachments/assets/539349dd-2c16-4f42-b525-cca74e113541'} />
...
This document will guide you on how to access and use AI models provided by Nvidia NIM in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in deepnova

  - Visit the `Application Settings` -> `AI Service Provider` interface in deepnova.
...
Now you can use the models provided by Nvidia NIM to have conversations in deepnova.
