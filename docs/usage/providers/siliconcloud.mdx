---
title: Using SiliconCloud in deepnova
description: >-
  Learn how to integrate and utilize SiliconCloud's language model APIs in deepnova.
...
# Using SiliconCloud in deepnova
...
This article will guide you on how to use SiliconCloud in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure SiliconCloud in deepnova
...
At this point, you can start chatting using the models provided by SiliconCloud in deepnova.
