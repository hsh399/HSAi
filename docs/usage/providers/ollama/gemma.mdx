---
title: Using Google Gemma Model in deepnova
description: >-
  Learn how to integrate and utilize Google Gemma in deepnova, an open-source large language model, in deepnova with the help of Ollama. Follow these steps to pull and select the Gemma model for natural language processing tasks.
...
<Image alt={'Using Gemma in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/65d2dd2a-fdcf-4f3f-a6af-4ed5164a510d'} />

[Gemma](https://blog.google/technology/developers/gemma-open-models/) is an open-source large language model (LLM) from Google, designed to provide a more general and flexible model for various natural language processing tasks. Now, with the integration of deepnova and [Ollama](https://ollama.com/), you can easily use Google Gemma in deepnova.

This document will guide you on how to use Google Gemma in deepnova:
...
Now, you can start conversing with the local Gemma model using deepnova.
