---
title: Using Local Qwen Model in deepnova
description: 通过deepnova和Ollama的集成，您可以轻松在deepnova中使用Qwen。本文将指导您如何在deepnova中使用本地部署版本的Qwen。
tags:
  - Qwen
  - deepnova
  - Ollama
...
<Image alt={'Using Qwen in deepnova'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6'} />
...
Now, through the integration of deepnova and [Ollama](https://ollama.com/), you can easily use Qwen in deepnova. This document will guide you on how to use the local deployment version of Qwen in deepnova:
...
<Steps>
  ...
  In the deepnova conversation page, open the model selection panel, and then select the Qwen model.
  ...
  <Callout type={'info'}>
    If you do not see the Ollama provider in the model selection panel, please refer to [Integration with Ollama](/docs/self-hosting/examples/ollama) to learn how to enable the Ollama provider in deepnova.
  </Callout>
</Steps>

Next, you can have a conversation with the local Qwen model in deepnova.
