---
title: Using Taichu API Key in deepnova
description: >-
  Learn how to integrate Taichu AI into deepnova for enhanced conversational experiences. Follow the steps to configure Taichu AI and start using its models.
...
# Using Taichu in deepnova

<Image alt={'Using Taichu in deepnova'} cover src={'https://github.com/user-attachments/assets/9cb27b68-f2ac-4ff9-8f97-d96314b1af03'} />

This article will guide you on how to use Taichu in deepnova:
...
<Steps>
  ...
  ### Step 2: Configure Taichu in deepnova
...
Now you can start conversing with the models provided by Taichu in deepnova.
