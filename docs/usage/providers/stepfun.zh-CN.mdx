---
title: 在 deepnova 中使用 Stepfun 阶跃星辰 API Key
description: 学习如何在 deepnova 中配置和使用 Stepfun 阶跃星辰的人工智能模型，包括获取 API Key 和选择模型开始对话。
tags:
  - Stepfun 阶跃星辰
  - API key
  - Web UI
...
# 在 deepnova 中使用 Stepfun 阶跃星辰

<Image alt={'在 deepnova 中使用 Stepfun 阶跃星辰'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563'} />
...
本文档将指导你如何在 deepnova 中使用 Stepfun 阶跃星辰:
...
<Steps>
  ...
  ### 步骤二：在 deepnova 中配置 Stepfun Stepfun 阶跃星辰
...
至此你已经可以在 deepnova 中使用 Stepfun 阶跃星辰提供的模型进行对话了。
