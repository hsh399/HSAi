---
title: Using Gitee AI in deepnova
description: >-
  Learn how to configure and use Gitee AI's API Key in deepnova to start conversations and interactions.
...
This article will guide you on how to use Gitee AI in deepnova.
...
<Steps>
  ...
  ### Step 2: Configure Gitee AI in deepnova

  - Access the `Settings` page in deepnova
...
Now you can start having conversations using the models provided by Gitee AI in deepnova!
