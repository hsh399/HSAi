---
title: Guide to Using Text-to-Image Models in deepnova
description: >-
  Learn how to utilize text-to-image generation in deepnova using DALL-E and Midjourney plugins. Generate images seamlessly with AI assistance.
...
# Guide to Using Text-to-Image Models in deepnova

deepnova supports text-to-image generation through a plugin mechanism. Currently, deepnova comes with the built-in DALL-E plugin, which allows users to generate images using OpenAI's DALL-E model. Additionally, users can also install the official Midjourney plugin to utilize the Midjourney text-to-image feature.
...
deepnova also offers the Midjourney plugin, which generates images by calling the Midjourney API. Please install the Midjourney plugin in the plugin store beforehand.
