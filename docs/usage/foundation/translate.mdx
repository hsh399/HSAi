---
title: Translation of Conversation Records - deepnova
description: >-
  Learn how to translate conversation content in deepnova with just one click. Customize translation models for accurate results.
...
deepnova supports users to translate conversation content into a specified language with just one click. After selecting the target language, deepnova will use a pre-set AI model for translation and display the translated results in real-time in the chat window.
