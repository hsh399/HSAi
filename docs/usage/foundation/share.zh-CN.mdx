---
title: 分享会话记录 - deepnova 分享功能介绍
description: 了解如何通过 deepnova 的分享功能分享会话记录，包括截图分享和 ShareGPT 分享方式。通过分享功能，轻松与他人分享您的对话。
tags:
  - deepnova
  - 分享会话记录
  - 截图分享
...
通过会话窗口右上角的`分享`按钮，您可以将当前会话记录分享给其他人。deepnova 支持两种分享方式：`截图分享`和 `ShareGPT 分享`。
...
[ShareGPT](https://sharegpt.com/) 是一个 AI 对话分享平台，允许用户便捷地分享他们与大型语言模型 (LLM) 的对话。用户只需点击即可生成永久链接，方便与朋友或其他人分享这些对话。deepnova 通过集成 ShareGPT 功能，可以一键将对话记录生成链接，方便分享。
