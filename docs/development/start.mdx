...
Welcome to the deepnova Technical Development Getting Started Guide. deepnova is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of deepnova and how to configure and use these technologies in your development environment.
...
1. **Get the code**: Clone the deepnova code repository locally:
...
deepnova uses `i18next` and `lobe-i18n` to implement multilingual support, ensuring a global user experience.
...
To support developers in better understanding and using the technology stack of deepnova, we provide a comprehensive list of resources and references — [deepnova Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [deepnova GitHub Discussions](https://github.com/lobehub/lobe-chat/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
