---
title: >-
  deepnova Launches Knowledge Base Feature: A New Experience in Intelligent File Management and Dialogue

description: >-
  deepnova introduces a brand new knowledge base feature that supports all types of file management, intelligent vectorization, and file dialogue, making knowledge management and information retrieval easier and smarter.
...
We are excited to announce that the highly anticipated deepnova knowledge base feature is now officially launched! 🎉 This feature is now available in both the open-source version and the Cloud version (deepnova.com).
...
All features are open-sourced on the [GitHub repository](https://github.com/lobehub/lobe-chat). We invite you to visit [deepnova Cloud](http://deepnova.com) to experience the full functionality.
