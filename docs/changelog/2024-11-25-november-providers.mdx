---
title: New Model Providers Added to deepnova in November
description: >-
  deepnova model providers now support Gitee AI, InternLM (ShuSheng PuYu), xAI, and Cloudflare WorkersAI
...
# New Model Providers Added to deepnova in November 🎉

We're excited to announce that deepnova has expanded its AI model support with the following providers:
