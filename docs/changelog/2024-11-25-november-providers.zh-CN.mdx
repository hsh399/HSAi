---
title: deepnova 11 月新增模型服务
description: 'deepnova 模型服务新增支持 Gitee AI, InternLM (书生浦语), xAI, Cloudflare WorkersAI'
tags:
  - deepnova
  - AI模型服务
  - Gitee AI
...
# deepnova 11 月新增模型服务支持 🎉

我们很高兴地宣布，deepnova 在 11 月份新增了以下 AI 模型服务的支持：
