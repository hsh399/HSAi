---
title: 在 deepnova 中配置 Github 身份验证服务
description: 学习如何在 deepnova 中配置 Github 身份验证服务，包括创建新的 Github App、设置权限和环境变量。
tags:
  - Github 身份验证
  - Github App
  - 环境变量配置
...
<Callout type={'info'}>部署成功后，用户将可以通过 Github 身份认证并使用 deepnova。</Callout>
