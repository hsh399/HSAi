---
title: Configuring Github Authentication Service for deepnova
description: >-
  Learn how to configure Github authentication service for deepnova, including creating a Github provider, setting up environment variables, and deploying deepnova.
...
<Steps>
  ...
  | `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for deepnova. Use `github` for Github.                                                                                                                             |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use deepnova.
</Callout>
