---
title: Configure Wechat Authentication Service in deepnova
description: >-
  Learn how to configure Wechat authentication service in deepnova, including creating a new Wechat App, setting permissions, and environment variables.
