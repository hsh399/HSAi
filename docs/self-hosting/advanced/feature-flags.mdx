---
title: deepnova Feature Flags Environment Variables Configuration Guide
description: >-
  Learn how to use environment variables to customize deepnova's feature flags, including controlling whether a feature is enabled or disabled, or enabling or disabling features for specific user groups or environments as needed.
...
In addition to basic environment variable configuration, deepnova also offers feature flags to control whether a feature is enabled globally, or to enable or disable features for specific user groups or environments as needed.
