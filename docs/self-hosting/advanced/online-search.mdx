...
description: >-
  Learn how to configure the SearXNG online search functionality for deepnova, enabling AI to access the latest web information.
...
You can find publicly available SearXNG instances in the [SearXNG instance list](https://searx.space/). Choose an instance that is fast and reliable, and then configure its URL in deepnova.
...
1. Restart the deepnova service.
...
- [deepnova Online Search RFC Discussion](https://github.com/lobehub/lobe-chat/discussions/6447)
