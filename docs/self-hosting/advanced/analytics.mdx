---
title: Integrating Data Analytics Services in deepnova for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in deepnova to collect user usage data efficiently.
...
To better help analyze the usage of deepnova users, we have integrated several free/open-source data analytics services in deepnova for collecting user usage data, which you can enable as needed.
