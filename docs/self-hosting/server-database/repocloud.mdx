---
title: Deploy deepnova with Database on RepoCloud
description: >-
  Learn how to deploy deepnova on RepoCloud with ease, including database, authentication and S3 storage service.
...
# Deploying deepnova Database Edition with RepoCloud

If you want to deploy deepnova Database Edition on RepoCloud, you can follow the steps below:
