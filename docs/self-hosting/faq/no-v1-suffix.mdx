---
title: >-
  Troubleshooting `OPENAI_PROXY_URL` in deepnova Configuration for Empty Response

description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response after configuring the deepnova `OPENAI_PROXY_URL` environment variable.
