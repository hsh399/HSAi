---
title: 通过 宝塔面板Docker应用商店 部署 deepnova
description: >-
  学习如何使用 宝塔面板Docker应用 部署 deepnova 服务，包括安装 Docker 容器环境和使用指令一键启动服务。详细说明如何配置环境变量和使用代理地址。
...
3. 安装完成后在`Docker-应用商店-AI/大模型`中找到 `deepnova`，点击`安装` ![安装](https://github.com/user-attachments/assets/db59a5e7-32ed-49d7-a791-8f8ee6618c01)

4. 设置域名等基本信息，点击`确定` ![设置](https://github.com/user-attachments/assets/37251adf-949b-4aec-bc49-bf4647e119da)

- 名称：应用名称，默认`deepnova_随机字符`
- 版本选择：默认`latest`
...
- 如果您填写域名，请在浏览器输入您的域名访问，如`http://demo.deepnova`，即可访问 `deepnova` 页面。
- 请在浏览器地址栏中输入域名访问 `http://<宝塔面板IP>:3210`，即可访问 `deepnova` 页面。 ![deepnova](https://github.com/user-attachments/assets/808f8849-5738-4a60-8ccf-01e300b0dc88)
