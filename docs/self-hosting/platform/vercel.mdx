---
title: Deploy deepnova with Vercel
description: >-
  Learn how to deploy deepnova on Vercel with ease. Follow the provided steps to prepare your OpenAI API Key, deploy the project, and start using it efficiently.
...
# Deploy deepnova with Vercel

If you want to deploy deepnova on Vercel, you can follow the steps below:
