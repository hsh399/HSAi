---
title: Deploy deepnova on Zeabur
description: >-
...
# Deploy deepnova with Zeabur

If you want to deploy deepnova on Zeabur, you can follow the steps below:
...
# Deploy deepnova with Zeabur as serverless function
...
Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy deepnova as a serverless function service. To deploy deepnova as a serverless function service on Zeabur, you can follow the steps below:
...
<Steps>
  ...
  ### Link your fork of deepnova to the just created Zeabur service.
