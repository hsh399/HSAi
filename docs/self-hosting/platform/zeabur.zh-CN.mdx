...
如果想在 Zeabur 上部署 deepnova，可以按照以下步骤进行操作：
...
# 使用 Zeabur 将 deepnova 部署为无服务器函数
...
由于 Zeabur 并未官方支持免费用户部署容器化服务，您可能希望将 deepnova 部署为无服务器函数服务。要在 Zeabur 上将 deepnova 部署为无服务器函数服务，您可以按照以下步骤操作：
...
<Steps>
  ...
  ### 将您的 deepnova 分支链接到刚创建的 Zeabur 服务。
