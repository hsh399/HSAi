---
title: Deploy deepnova with Railway
description: >-
  Learn how to deploy deepnova on Railway and follow the step-by-step process. Get your OpenAI API Key, deploy with a click, and start using it. Optionally, bind a custom domain for your deployment.
...
# Deploy deepnova with Railway

If you want to deploy deepnova on Railway, you can follow the steps below:
